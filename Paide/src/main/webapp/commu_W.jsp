...
<head>
<title>PAI:DE | commu_W.농촌일자리</title>
<meta charset="utf-8">
	...
	<div id="wrapper">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="commu_W.html" class="active"><i class="lnr lnr-list"></i> <span>농촌일자리</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h5 class="page-title">
						<i class="lnr lnr-home"></i> HOME <i class="lnr lnr-chevron-right"></i><strong>농촌일자리</strong>
					</h5>
							...
							<div class="container-fluid">
								<div class="row">
                                 ...
                                 <img id = "boardimg" alt="Bootstrap Image Preview" src="assets/img/게시판1.jpg" max-width="100%" height="auto"/> 
										...
										<div class="thumbnail-wrapper">
											<div class="thumbnail">
												<img id="boardimg" alt="Bootstrap Image Preview" src="assets/img/board3.jpg" />
											</div>
										</div>
									</div>
								</div>
