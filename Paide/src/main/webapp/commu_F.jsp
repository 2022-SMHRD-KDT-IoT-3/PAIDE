...
<head>
<title>PAI:DE | commu_F.자유게시판</title>
<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="assets/img/pidelogoSmall.png" alt="piede Logo" class="img-responsive logo"></a>
			</div>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle icon-menu" data-toggle="dropdown"> <i class="lnr lnr-users"></i> <!-- 변경 5 =  이웃의 수 만큼 count가 되어야 함. --> <span class="badge rounded-pill bg-success">5</span>
                          ...
                          사용자의 이웃의 수 만큼 li 반복 되어야합니다  --> <!-- "m_id"의 코드가 들어가고, 클릭 시, 해당 회원의 농장화면으로 넘어감. -->
							...
							<ul id='neighbor' class="dropdown-menu notifications">
								<li><a href="OtherFarm.html" class="notification-item"><span class="lnr lnr-user"></span>&nbsp;damin0722</a></li>
								<li><a href="OtherFarm.html" class="notification-item"><span class="lnr lnr-user"></span>&nbsp;chanyoung0831</a></li>
								<li><a href="OtherFarm.html" class="notification-item"><span class="lnr lnr-user"></span>&nbsp;seolmi0303</a></li>
								<li><a href="OtherFarm.html" class="notification-item"><span class="lnr lnr-user"></span>&nbsp;hyeonji2231</a></li>
								<li><a href="OtherFarm.html" class="notification-item"><span class="lnr lnr-user"></span>&nbsp;jingwan1996</a></li>
							</ul></li>
						<!-- 로그아웃시 삭제1 end-->
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="commu_F.html" class="active"><i class="lnr lnr-list"></i> <span>자유게시판</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h5 class="page-title">
						<i class="lnr lnr-home"></i> HOME <i class="lnr lnr-chevron-right"></i><strong>자유게시판</strong>
					</h5>
							...
							<div class="container-fluid">
								<div class="row">
                                 ...
                                 <img id = "boardimg" alt="Bootstrap Image Preview" src="assets/img/게시판1.jpg" max-width="100%" height="auto"/> 
										...
										<div class="thumbnail-wrapper">
											<div class="thumbnail">
												<img id="boardimg" alt="Bootstrap Image Preview" src="assets/img/board4.jpg" />
											</div>
										</div>
									</div>
								</div>
