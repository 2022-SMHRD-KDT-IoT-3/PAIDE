...
public class WriteFCmtService implements Command {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		int t_farm_seq = Integer.parseInt(request.getParameter("f_seq"));
		...
		CommunityDTO dto = new CommunityDTO(m_id, 0, t_farm_seq, fcmt_content,"", 0);
		
		
		int result = dao.Insert_Fcmt(dto);
